var arrLang = {
    ...
    "jp": {
        ...
        "hello, there": "< 「こんにちは！」",
        "intro": "\
                私は樊家輝と申します。南京理工大学のPCA Labの博士課程大学院生です。私のメンターは楊健教授と王貝貝教授であります。今、私は主にコンピュータグラフィックス（CG）と機械学習に関する研究を行っています。この前に、コンピュータビジョンを専攻していましたが、博士課程の1年生(2020年)頃からCGの分野に取り組み始め、関連する論文もいくつか完了しました。現実の世界と仮想の世界の両方ですべてがどのように機能するかという原則を理解し、活用することに、私は常に深い興味を持っています。そして、私と同じ趣味と情熱を持つ友達と交流することをぜひとも願っています。ご質問やお問い合わせなどもご自由にどうぞ！ \
        ",
